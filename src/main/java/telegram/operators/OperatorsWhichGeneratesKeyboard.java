...
//                .getAllMemberInGroup(0, data.getData().getIdGroup(), data.getConnector());
...
//        ArrayList<Member> membersInGroup = new GroupDao().getAllMemberInGroup(0, data.getData().getIdGroup(), data.getConnector());
